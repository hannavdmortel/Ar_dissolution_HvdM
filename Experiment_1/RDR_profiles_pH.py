...
filepath = "C:/Users/hanna/Documents/GitHub/Ar_dissolution_HvdM/Experiment_1"
...
labels =    ['Center', 
             ...
             'SWI',
             'RDR1 (no aragonite)',
             'RDR2 (15 aragonite balls)',
             'RDR3 (30 aragonite balls)',
             'Baseline',
             ]
...
patchList.append(Line2D([0], [0], color='grey', alpha=0.8, linewidth=1.5, linestyle='--', label='Baseline'))
